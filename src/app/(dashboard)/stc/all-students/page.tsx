...
import { setUnchangedStudentsList, setSelectedStudentId, stcSelector, setFakeNewStudentId } from "@/redux/stc/stcSlice";
...
export default function Home() {
	...
	const { unchangedStudentsList, fakeNewStudentId } = useAppSelector(stcSelector);
