...
export default function Home(){
    return (
        ...
        <section className=" bg-black h-[270px] rounded-[10px] py-4 p-2 flex flex-col justify-between">
          ...
          <button className="w-fit bg-[#00932E] rounded-md px-4 py-2 text-[16px] leading-[24px] text-white font-bold">Update Profile</button>
          </div>
        </section>
        <section className="bg-[#00932E] p-4 space-y-4">
          ...
          <div className=" flex flex-col md:flex-row md:justify-between gap-4 md:gap-0 items-center md:items-start">
            <div className="md:w-[33%] w-[95%] flex flex-col gap-4 p-4 bg-white rounded-[12px]">
              <Bag />
