...
export default function About() {
    ...
    return (
      ...
      <section className=" bg-[#00932E] p-8 flex flex-col md:flex-row gap-4">
        <div className=" space-y-6 flex-1 py-16">
          <h4 className="text-[18px] leading-[24px] text-white text-center md:text-left">OUR NEXT MILESTONE</h4>
          <h2 className=" text-[44px] leading-[48px] text-white text-center md:text-left font-medium">We are National Skills Information Center</h2>
          <p className=" text-[18px] leading-[24px] text-white text-center md:text-left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde dolorem delectus voluptatum odio voluptates. Officiis doloremque, mollitia architecto ullam, sequi, adipisci quo sapiente ut optio iste porro necessitatibus nisi cupiditate unde tenetur. Sapiente laboriosam magni voluptates, ullam id voluptatibus numquam! Lorem ipsum dolor sit, amet consectetur adipisicing elit. A dolorum minima quos dolore repellat sit atque eius odio, provident fugit, nemo aliquid vel ullam magni doloribus in earum non, obcaecati quibusdam! Nostrum, asperiores! Quaerat hic, ex tenetur provident harum at!</p>
        </div>
        <div className=" flex-1">
          <Image src="/images/landing/World Map.png" width={1298} height={400} alt="" />
        </div>
      </section>
      </section>
    );
