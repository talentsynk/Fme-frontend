...
export const RootHeader = () => {
    ...
    return ( 
        ...
        <header className="flex items-center p-2 md:px-8 md:py-6">
            ...
            <nav className={`flex-col ${!showNav ? 'md:flex hidden' : 'flex'} space-y-4 md:space-y-0 md:flex-row flex-1 justify-between`}>
                <ul className="flex flex-col md:flex-row md:gap-12 md:items-center">
                    <li className={`md:hover:text-[#00932E] hover:bg-[rgb(0,147,46)] md:hover:bg-white rounded-md md:rounded-none p-2 md:p-2 hover:text-white ${pathname === '/faqs' ? 'text-[#00932E] font-bold' : ''}`}>
                        <Link href="/faqs">FAQs</Link>
                    </li>
                    <li className={`md:hover:text-[#00932E] hover:bg-[#00932E] md:hover:bg-white rounded-md md:rounded-none p-2 md:p-2 hover:text-white ${pathname === '/about' ? 'text-[#00932E] font-bold' : ''}`}>
            ...
            {!showNav ? (
                <div onClick={ShowNav} className="flex gap-2 items-center md:hidden rounded-md px-4 py-2 font-semibold text-sm text-white bg-[#00932E] ml-auto">
                    <Hamburger />
                    <h6 className="">Menu</h6>
                </div>
            ) : (
