...
import { IStudentData, StudentItemDropdownList, IStudentDropdownFunc } from "../../fme/students/data";
...
import { mdaSelector, setSelectedStudentId } from "@/redux/mda/mdaSlice";
import { useAppDispatch, useAppSelector } from "@/redux/hooks/hooks";
import { truncateString } from "@/utils/truncateString";
import { IFilterBtn } from "@/components/fme/mda/data";
...
export const StudentTableRow: React.FC<IStudentCompData> = ({ FirstName, LastName, CoursesTaken, Email, ID, IsActive, StateOfResidence, UserID }) => {
	...
	const { selectedStudentId } = useAppSelector(mdaSelector);
	// set dispatch
