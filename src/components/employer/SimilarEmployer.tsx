...
import { BlackSmallBag, SmallVerified } from '../landing/faqs/Svgs'
import Image from 'next/image'

const SimilarEmployer = () => {
  return (
    <section className=" border-[rgb(235,237,239)] border-[1px] border-solid rounded-lg p-1 flex flex-col gap-4">
        ...
        <div className=" space-y-4">
            <div className=" flex justify-between items-center">
                <h5 className=" text-lg font-bold leading-6">Oragon Confectioneries</h5>
            ...
            <div className=" text-black-25 text-sm font-medium">4.5/5.0</div>
