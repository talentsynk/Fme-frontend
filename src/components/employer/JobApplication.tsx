...
const JobApplication:React.FC<IJob> = ({BusinessName,BusinessDescription,ApplicationStatus,JobApplicationDate,ArtisanId,JobId,ApplicationId}) => {
  ...
  <div className="flex flex-col gap-4">
    ...
    {ApplicationStatus !== "listed" ? (
      ...
      <Link href={`/dashboard/employer/hire/${ArtisanId}/${JobId}/${ApplicationId}`}>
      ...
      <div className="flex gap-1">
        ...
        {showHireProfessionalModal && <HireProfessionalComp JobId={JobId} artisanId={data?.ID} handleModAction={handleProfessionalAction} cancelModal={() => setShowHireProfessionalModal(false)} />}
