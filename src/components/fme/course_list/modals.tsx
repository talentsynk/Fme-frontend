  ...
  const handleCategoryInput = (
    ...
    if (input == "Description") {
      ...
      if (value.trim().length < 1) {
        setDescriptionError({
          active: true,
          text: "Course category  is required",
        });
      } else {
        setDescriptionError({
          active: false,
          text: "Course category  is valid",
        });
              ...
              <NewMdaFormStyles className="bd">
                <div className="fl">
                  <div className="form-head">
                    ...
                    <p>
                      Fill in the necessary details to add a new course category
                    </p>
                  </div>
                    ...
                    <div className="form-ele">
                      ...
                      <div className="inp">
                        <textarea
                          ...
                          value={Description}
                          onChange={(e: any) =>
                            handleCategoryInput(e, "Description")
                          }
                        ...
                        <p
                          ...
                          aria-atomic="true"
                          className={
                            DescriptionError.active ? "error-msg" : "correct"
                          }
                        >
                          {DescriptionError.text}
                        </p>
  ...
  const handleInput = (
    ...
    if (input == "Description") {
      ...
      if (value.trim().length < 1) {
        setDescriptionError({
          active: true,
          text: "Course description  is required",
        });
      } else {
        setDescriptionError({
          active: false,
          text: "Course description  is valid",
        });
        setForm({ ...form, Description: value });
      }
    }
      ...
      {isSuccess && (
        <FlexAbsoluteModalStyles>
          <SuccessModal
            ...
            msg="The new course was created successfully. Have a lovely day!"
            cancelModal={cancelModal}
            icon={<CreationSuccessIcon />}
            navigationText="Go back to Dashboard"
            hasCancel={true}
      ...
      <FlexAbsoluteModalStyles>
        ...
        {isSuccess && (
          <SuccessModal
            ...
            msg="MDA was successfully suspended. Have a lovely day!"
            cancelModal={cancelModal}
            navigationText="Go back to Dashboard"
            hasCancel={true}
