                ...
                <div className="details">
                  ...
                  <div className="dx">
                    <div className="name">
                      ...
                      <p className="nm">
                        1, Ajanaku street, Agege, Lagos State.
                      </p>
                    </div>
                    <CopyIcon text="124, Oyediran Estate, Lagos, Nigeria, 5432" />
                  </div>
                  ...
                  <div className="dx">
                    <div className="name">
                      ...
                      <p className="nm">
                        Oluwatimilehin Alarape PDF.pdf
                      </p>
                    </div>
                    <CopyIcon text="124, Oyediran Estate, Lagos, Nigeria, 5432" />
                  </div>
            ...
            <TwoButtonModalStyles>
              <div className="pop">
                <div className="up">
                  ...
                  <h4>Suspend Student?</h4>
                  <p>
                    Are you sure you want to suspend this Student? It will no longer
            ...
            <TwoButtonModalStyles>
              <div className="pop">
                <div className="up">
                  ...
                  <p>
                    You are about to re-activate this student and restore it to its latter glory. Are you sure you want to take this action?
                  </p>
                </div>
                <div className="down">
                  <button type="button" onClick={cancelModal} className="cancel">
