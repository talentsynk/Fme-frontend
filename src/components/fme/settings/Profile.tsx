 ...
 return (
    <div className="flex p-8">
      <div className="w-[30%] space-y-2">
        ...
        <button onClick={handleSubmit} className={`w-[129px] h-9 text-white font-semibold border-[1px] rounded-md ${isFormEmpty() || !isEmailValid || !isPasswordValid ? 'bg-[#D0D5DD] cursor-not-allowed' : 'bg-[#00932E] border-[#00932E] hover:bg-[#007427]'}`}
          disabled={isFormEmpty() || !isEmailValid || !isPasswordValid}
          type="submit">Save changes </button>
      </div>
      <form action="" className="w-[70%] space-y-4">
        <div className="">
          <label htmlFor="firstName" className="text-[#101928] font-semibold text-sm">Name of FME</label>
          <input className="w-full border-[#D0D5DD] border-solid rounded-md p-4 border focus:border-[#00932E]" type="text" id="firstName" name="name" value={settingsData.name}
            onChange={handleChange} />
        </div>
        <div className="">
          <label htmlFor="email" className="text-[#101928] font-semibold text-sm">Email address</label>
          <div className="w-full relative">
            <input onChange={handleChange} type="email" id='email' name="email" value={settingsData.email} className="w-full border-[#D0D5DD] border-solid rounded-md p-4 border focus:border-[#00932E]" />
            <Letter />
          </div>
        ...
        <div className="">
          ...
          <input className="w-full border-[#D0D5DD] border-solid rounded-md p-4 border focus:border-[#00932E]" type="password" name="password"
